...
function drawTypeMenu(ctx) {
  ...
  ctx.fillText("Choose a difficulty. High scores are saved on this device.", TYPE_W / 2, 72);
  ...
  ctx.font = "13px sans-serif";
  ctx.fillText("Click a mode or press 1–5", TYPE_W / 2, TYPE_H - 28);
}
...
function drawTypeGameOver(ctx) {
  ...
  ctx.fillStyle = "#9aa3ad";
  ctx.font = "15px sans-serif";
  ctx.fillText("Space: play again    Esc: change difficulty", TYPE_W / 2, TYPE_H / 2 + 56);
}
